...
template class app::gfx::FxParamManager::Interpolator<hh::needle::FxFogParameter>;
...
template class app::gfx::FxParamManager::Interpolator<hh::needle::FxTimeStopParameter>;
template class app::gfx::FxParamManager::Interpolator<hh::needle::FxRenderTargetSetting>;
...
template class app::gfx::FxParamManager::Interpolator<hh::needle::FxModelParameter>;
template class app::gfx::FxParamManager::Interpolator<hh::gfx::PerformanceSetting>;
